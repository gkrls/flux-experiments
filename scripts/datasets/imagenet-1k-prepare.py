...
def main():
    ...
    parser.add_argument('input_dir', help='Input directory with tar files (or dataset to verify)')
    ...
    if args.verify_only:
        ...
        print(f"Verifying dataset at: {input_dir}")
        
        if verify_dataset(input_dir):
            print("\n✓ Verification PASSED")
            return 0
        else:
            print("\n✗ Verification FAILED")

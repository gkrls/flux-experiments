...
def train_one_epoch(model, dataloader, optimizer, device, scaler, args,
    ...
    while True:
        ...
        if args.micro_steps_per_epoch and micro_count >= args.micro_steps_per_epoch: break
...
def train(args, straggle, best_model_group):
    ...
    for epoch in range(args.epochs):
        ...
        if val_metrics['ppl'] < best_ppl: best_ppl = val_metrics['ppl']

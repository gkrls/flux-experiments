...
def get_dataloaders(args):
    "Create dataloaders and apply standard augmentation"
    ...
    train_loader = torch.utils.data.DataLoader(
        train_dataset, batch_size=args.batch_size, sampler=train_sampler, num_workers=args.workers, pin_memory=True,
...
def validate(model, loader, device, args):
    ...
    # no metric aggregation. we calculate this offline afterwards

...
if __name__ == "__main__":
    ...
    p.add_argument("--labels",            nargs=2, default=["proactive", "reactive"])
    ...
    # GPT
    # a.input_a = DIR / "gpt/natural/proactive"
    # a.input_b = DIR / "gpt/natural/reactive"
    # a.metric = "val_ppl"
    # a.target = 28.00
    # a.tolerance = 0.01
    # a.rank = "avg"
    ...
    # Qwen2.5-0.5B
    # a.input_a = DIR / "qwen/natural/proactive"
    # a.input_b = DIR / "qwen/natural/reactive"

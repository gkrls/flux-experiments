...
def plot(input_a, input_b, metric, labels=("SU", "SA"),
...
if __name__ == "__main__":
    p = argparse.ArgumentParser(description="Time-to-Metric/Time-to-Step plot")
    ...
    # a.input_b = DIR / "resnet/moderate/sa"
    a.metric = "val_top5"
    a.target = 90
    a.tolerance = 0.01
    a.rank = "avg"
    ...
    # GPT
    # a.input_a = DIR / "gpt/aggressive/su"
    # a.input_b = DIR / "gpt/aggressive/sa"
    # a.input_a = DIR / "gpt/moderate/su"
    # a.input_b = DIR / "gpt/moderate/sa"
    # a.metric = "val_ppl"
    # a.target = 28.00
    # a.tolerance = 0.01
    # a.rank = "avg"
    ...
    # Qwen2.5-0.5B
    # a.input_a = DIR / "qwen/aggressive/su"
    # a.input_b = DIR / "qwen/aggressive/sa"
    # a.input_a = DIR / "qwen/moderate/su"
    # a.input_b = DIR / "qwen/moderate/sa"
    ...
    plot(a.input_a, a.input_b, a.metric, a.labels, a.minival, a.target,
